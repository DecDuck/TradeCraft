<template>
  <div
    class="px-4 py-4 md:py-8 max-w-3xl grid grid-cols-3 gap-4"
  >
    ...
    <Card class="hidden md:flex text-center text-zinc-500 text-sm flex-col items-center justify-center gap-y-2">
